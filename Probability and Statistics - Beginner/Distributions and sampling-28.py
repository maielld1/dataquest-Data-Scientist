...
lowest_income_high_pop_count = income['county'][(income['median_income']==min(income['median_income']))&(income['pop_over_25']>500000)]
...
deviations_from_mean = abs(0.18 - numpy.mean(large_sample))/large_sample_std
over_18_count = 0
for x in large_sample:
    if x>=0.18:
        over_18_count+=1
