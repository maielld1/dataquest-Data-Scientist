...
true_positives = admissions[(admissions['predicted_label']==1)&(admissions['actual_label']==1)]
true_negatives = admissions[(admissions['predicted_label']==0)&(admissions['actual_label']==0)]
